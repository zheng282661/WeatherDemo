...
.jp-container .talk_recordbox .talk_recordtextbg {
	...
	height: 30px;
	display: block;
	background-image: url(${basePath}/resource/image/talk_recordtext.png);
...
.jp-container .talk_recordboxme .talk_recordtextbg {
	...
	height: 30px;
	display: block;
	background-image: url(${basePath}/resource/img/talk_recordtext_2.png);
	background-repeat: no-repeat;
	background-position: left top;
	background-repeat: no-repeat;
}
...
<script type="text/javascript" src="${basePath}/resource/js/chat.js"></script>
<script type="text/javascript" src="${basePath}/resource/js/MediaStreamRecorder.js"></script>
		...
		<table border="0">
				...
				<td><div id="chartRoom" class="easyui-panel"
						...
						<div class="jp-container">
							...
							<div class="talk_recordboxme" id="loading" style="display: none">
								<div class="user">
									<img src="${basePath}/resource/image/robort.png" />机器人
								</div>
								<div class="talk_recordtextbg">&nbsp;</div>
								<div class="talk_recordtext">
									I am thinking..<img
										src="${basePath}/resource/js/themes/bootstrap/images/loading.gif" /> <span
			...
			<tr align="right">
				...
				<td><div id="chartRoom" class="easyui-panel"
						...
						<input type="text" id="send_btn"  style="width: 270px" ></input>
                       
						<!--
						&nbsp;
 <input type="text" onkeypress="if(event.keyCode==13) {send();return false;}" style="width: 270px" id="questionText"></input>
                            <input type="button" id="recordBtn" onmousedown="record()" onmouseup="sendrecord()" value="按下录音" />
						 -->
					</div></td>
